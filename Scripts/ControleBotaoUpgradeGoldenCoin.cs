...
public class ControleBotaoUpgradeGoldenCoin : ControleBotaoUpgrade {
    ...
    private void compraUpgrade()
    {
        ...
        //ativa o upgrade
        propriedadesUpgrades.ativaUpgradeFrequenciaGoldenCoin(upgrade.index);
    ...
    {
        GetComponent<Image>().sprite = propriedadesUpgrades.spritesUpgradeAumentosFrequenciaGoldenCoin[upgrade.index];
    }
}
