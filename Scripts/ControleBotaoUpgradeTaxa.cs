...
public class ControleBotaoUpgradeTaxa : ControleBotaoUpgrade {
    ...
    private void compraUpgrade()
    {
        ...
        propriedadesDinheiro.realizaCompra(upgrade.index);

        //ativa o upgrade
        propriedadesUpgrades.ativaUpgradeTaxa(upgrade.index);
    ...
    {
        GetComponent<Image>().sprite = propriedadesUpgrades.spritesUpgradesAumentosTaxa[upgrade.index];
    }
}
